OpenEstate-IO-Build 1.5-SNAPSHOT
================================

*OpenEstate-IO-Build* is a Java library, that provides some helper classes used
to build the *OpenEstate-IO* libraries. This library is not required at runtime.
