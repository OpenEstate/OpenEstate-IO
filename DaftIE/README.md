...
-   read XML data according to the specifications of
    ...
    (see [`DaftIeReadingExample.java`](https://github.com/OpenEstate/OpenEstate-IO/blob/v1.0-RC1/Examples/src/main/java/org/openestate/io/examples/DaftIeReadingExample.java))
-   write XML data according to the specifications of
    [*daft.ie*](http://daft.ie) in version 2.7
    (see [`DaftIeWritingExample.java`](https://github.com/OpenEstate/OpenEstate-IO/blob/v1.0-RC1/Examples/src/main/java/org/openestate/io/examples/DaftIeWritingExample.java))
