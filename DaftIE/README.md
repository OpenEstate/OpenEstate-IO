...
-   read XML data according to the specifications of [daft.ie](http://daft.ie)
    in version 2.7
...
-   write XML data according to the specifications of [daft.ie](http://daft.ie)
    in version 2.7
...
documentations in the PDF file.
...
-   [Validator for Daft-XML](http://validator.openestate.org/)
