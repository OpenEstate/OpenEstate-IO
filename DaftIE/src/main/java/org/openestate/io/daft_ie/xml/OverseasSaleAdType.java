    ...
    implements Cloneable, CopyTo, Equals, ToString
{
    ...
    @XmlElement(name = "is_new_development", type = String.class)
    @XmlJavaTypeAdapter(Adapter6 .class)
    protected Boolean isNewDevelopment;
    @XmlElement(name = "units_available", type = String.class)
    @XmlJavaTypeAdapter(Adapter4 .class)
    protected Integer unitsAvailable;
    @XmlElement(name = "new_development_availability")
    protected String newDevelopmentAvailability;
    @XmlElement(name = "square_metres", type = String.class)
     ...
     *     
     */
    public String getNewDevelopmentAvailability() {
     ...
     *     
     */
    public void setNewDevelopmentAvailability(String value) {
     ...
     *     
     */
    public void setCo2Rating(String value) {
     ...
     *     
     */
    public void setEnergyRating(String value) {
     ...
     *     
     */
    public void setViewingDetails(String value) {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            String theNewDevelopmentAvailability;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof OverseasSaleAdType) {
            ...
            if (this.newDevelopmentAvailability!= null) {
                String sourceNewDevelopmentAvailability;
                sourceNewDevelopmentAvailability = this.getNewDevelopmentAvailability();
                String copyNewDevelopmentAvailability = ((String) strategy.copy(LocatorUtils.property(locator, "newDevelopmentAvailability", sourceNewDevelopmentAvailability), sourceNewDevelopmentAvailability));
            ...
            if (this.directions!= null) {
                ...
                String copyDirections = ((String) strategy.copy(LocatorUtils.property(locator, "directions", sourceDirections), sourceDirections));
                copy.setDirections(copyDirections);
            } else {
                copy.directions = null;
            }
            if (this.co2Rating!= null) {
                String sourceCo2Rating;
                sourceCo2Rating = this.getCo2Rating();
                String copyCo2Rating = ((String) strategy.copy(LocatorUtils.property(locator, "co2Rating", sourceCo2Rating), sourceCo2Rating));
                copy.setCo2Rating(copyCo2Rating);
            } else {
                copy.co2Rating = null;
            }
            if (this.energyRating!= null) {
                String sourceEnergyRating;
                sourceEnergyRating = this.getEnergyRating();
                String copyEnergyRating = ((String) strategy.copy(LocatorUtils.property(locator, "energyRating", sourceEnergyRating), sourceEnergyRating));
                copy.setEnergyRating(copyEnergyRating);
            } else {
                copy.energyRating = null;
            }
            if (this.viewingDetails!= null) {
                String sourceViewingDetails;
                sourceViewingDetails = this.getViewingDetails();
                String copyViewingDetails = ((String) strategy.copy(LocatorUtils.property(locator, "viewingDetails", sourceViewingDetails), sourceViewingDetails));
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            String lhsNewDevelopmentAvailability;
            lhsNewDevelopmentAvailability = this.getNewDevelopmentAvailability();
            String rhsNewDevelopmentAvailability;
        ...
        {
            String lhsDirections;
            lhsDirections = this.getDirections();
            String rhsDirections;
        ...
        {
            String lhsEnergyRating;
            lhsEnergyRating = this.getEnergyRating();
            String rhsEnergyRating;
        ...
        {
            String lhsViewingDetails;
            lhsViewingDetails = this.getViewingDetails();
            String rhsViewingDetails;
    ...
    public enum PriceType {
        ...
        public static OverseasSaleAdType.PriceType fromValue(String v) {
