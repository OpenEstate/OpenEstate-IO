...
-   read XML data according to the specifications of
    ...
    (see [`TrovitReadingExample.java`](https://github.com/OpenEstate/OpenEstate-IO/blob/v1.0-RC1/Examples/src/main/java/org/openestate/io/examples/TrovitReadingExample.java))
-   write XML data according to the specifications of
    [*trovit.com*](http://trovit.com)
    (see [`TrovitWritingExample.java`](https://github.com/OpenEstate/OpenEstate-IO/blob/v1.0-RC1/Examples/src/main/java/org/openestate/io/examples/TrovitWritingExample.java))
