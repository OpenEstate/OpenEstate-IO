OpenEstate-IO-Trovit 1.0-SNAPSHOT
=================================
...
-   read XML data according to the specifications of [trovit.com](http://trovit.com)
...
-   write XML data according to the specifications of [trovit.com](http://trovit.com)
...
-   [Validator for Trovit-XML](http://validator.openestate.org/)
