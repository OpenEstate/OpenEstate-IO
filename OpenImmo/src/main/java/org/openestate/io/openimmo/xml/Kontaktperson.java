    ...
    implements Cloneable, CopyTo, Equals, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            strategy.appendField(locator, this, "emailFeedback", buffer, theEmailFeedback);
        }
        {
            String theTelPrivat;
        ...
        }
        {
            ...
            strategy.appendField(locator, this, "immobilientreuhaenderid", buffer, theImmobilientreuhaenderid);
        }
        {
            Foto theFoto;
            theFoto = this.getFoto();
            strategy.appendField(locator, this, "foto", buffer, theFoto);
        }
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Kontaktperson) {
            ...
            if (this.emailFeedback!= null) {
                String sourceEmailFeedback;
                sourceEmailFeedback = this.getEmailFeedback();
                String copyEmailFeedback = ((String) strategy.copy(LocatorUtils.property(locator, "emailFeedback", sourceEmailFeedback), sourceEmailFeedback));
            ...
            if (this.immobilientreuhaenderid!= null) {
                String sourceImmobilientreuhaenderid;
                sourceImmobilientreuhaenderid = this.getImmobilientreuhaenderid();
                String copyImmobilientreuhaenderid = ((String) strategy.copy(LocatorUtils.property(locator, "immobilientreuhaenderid", sourceImmobilientreuhaenderid), sourceImmobilientreuhaenderid));
            ...
            if (this.foto!= null) {
                ...
                Foto copyFoto = ((Foto) strategy.copy(LocatorUtils.property(locator, "foto", sourceFoto), sourceFoto));
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof Kontaktperson)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "emailFeedback", lhsEmailFeedback), LocatorUtils.property(thatLocator, "emailFeedback", rhsEmailFeedback), lhsEmailFeedback, rhsEmailFeedback)) {
                return false;
            }
        }
        {
        ...
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "immobilientreuhaenderid", lhsImmobilientreuhaenderid), LocatorUtils.property(thatLocator, "immobilientreuhaenderid", rhsImmobilientreuhaenderid), lhsImmobilientreuhaenderid, rhsImmobilientreuhaenderid)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "foto", lhsFoto), LocatorUtils.property(thatLocator, "foto", rhsFoto), lhsFoto, rhsFoto)) {
                return false;
            }
        }
        {
