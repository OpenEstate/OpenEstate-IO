    ...
    implements Cloneable, CopyTo, Equals, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            strategy.appendField(locator, this, "parken", buffer, theParken);
        }
        {
        ...
        }
        {
            ...
            strategy.appendField(locator, this, "objektartZusatz", buffer, theObjektartZusatz);
        }
        return buffer;
    }
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Objektart) {
            ...
            if ((this.parken!= null)&&(!this.parken.isEmpty())) {
                List<Parken> sourceParken;
                sourceParken = (((this.parken!= null)&&(!this.parken.isEmpty()))?this.getParken():null);
                @SuppressWarnings("unchecked")
                List<Parken> copyParken = ((List<Parken> ) strategy.copy(LocatorUtils.property(locator, "parken", sourceParken), sourceParken));
                copy.parken = null;
                if (copyParken!= null) {
            ...
            if ((this.objektartZusatz!= null)&&(!this.objektartZusatz.isEmpty())) {
                ...
                @SuppressWarnings("unchecked")
                List<String> copyObjektartZusatz = ((List<String> ) strategy.copy(LocatorUtils.property(locator, "objektartZusatz", sourceObjektartZusatz), sourceObjektartZusatz));
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "parken", lhsParken), LocatorUtils.property(thatLocator, "parken", rhsParken), lhsParken, rhsParken)) {
                return false;
            }
        }
        {
        ...
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "objektartZusatz", lhsObjektartZusatz), LocatorUtils.property(thatLocator, "objektartZusatz", rhsObjektartZusatz), lhsObjektartZusatz, rhsObjektartZusatz)) {
                return false;
            }
        }
        return true;
