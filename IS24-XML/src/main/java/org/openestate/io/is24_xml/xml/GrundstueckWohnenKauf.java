    ...
    extends JAXBElement<GrundstueckWohnenKauf.Type>
{
        ...
        implements Cloneable, CopyTo, Equals, ToString
    {
        ...
        public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
            ...
            if (draftCopy instanceof GrundstueckWohnenKauf.Type) {
                ...
                if (this.vermarktung!= null) {
                    ...
                    VermarktungGrundstueckWohnenKaufTyp copyVermarktung = ((VermarktungGrundstueckWohnenKaufTyp) strategy.copy(LocatorUtils.property(locator, "vermarktung", sourceVermarktung), sourceVermarktung));
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
            if (!(object instanceof GrundstueckWohnenKauf.Type)) {
                return false;
            }
            if (this == object) {
                return true;
