    ...
    extends JAXBElement<WohnungMiete.Type>
{
    ...
    protected final static QName NAME = new QName("http://www.immobilienscout24.de/immobilientransfer", "WohnungMiete");

    public WohnungMiete(WohnungMiete.Type value) {
        super(NAME, ((Class) WohnungMiete.Type.class), null, value);
    }

    public WohnungMiete() {
        super(NAME, ((Class) WohnungMiete.Type.class), null, null);
    }
        ...
        implements Cloneable, CopyTo, Equals, ToString
    {
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
            if (!(object instanceof WohnungMiete.Type)) {
                return false;
            }
            if (this == object) {
                return true;
