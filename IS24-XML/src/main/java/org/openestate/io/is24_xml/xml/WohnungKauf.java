    ...
    extends JAXBElement<WohnungKauf.Type>
{
    ...
    protected final static QName NAME = new QName("http://www.immobilienscout24.de/immobilientransfer", "WohnungKauf");

    public WohnungKauf(WohnungKauf.Type value) {
        super(NAME, ((Class) WohnungKauf.Type.class), null, value);
    }

    public WohnungKauf() {
        super(NAME, ((Class) WohnungKauf.Type.class), null, null);
    }
        ...
        implements Cloneable, CopyTo, Equals, ToString
    {
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
            if (!(object instanceof WohnungKauf.Type)) {
                return false;
            }
            if (this == object) {
                return true;
