...
public abstract class XmlDocument<JavaType>
{
   ...
   *
   * @return
   * true, if CDATA is used for XML generation
   */
   ...
   *
   * @param doc
   * the document, that will be written to XML
   *
   * @throws IOException
   * if an error occured and XML generation should be stopped
   */
   ...
   *
   * @return
   * created object, that represents the contained {@link Document}
   *
   * @throws JAXBException
   * if the Java object is not creatable
   */
   ...
   *
   * @param xmlFile
   * the file, where the XML code is written to
   *
   ...
   *
   * @param output
   * the output, where the XML code is written to
   *
   * @throws TransformerException
   * if XML transformation failed
   *
