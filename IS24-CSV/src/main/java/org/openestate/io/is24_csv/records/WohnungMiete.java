...
public class WohnungMiete extends Is24CsvRecord
{
  ...
  /** Einbauküche, Text 1 */
  protected final static int FIELD_EINBAUKUECHE = 74;

  /** Seniorengerechtes Wohnen, Text 1 */
  protected final static int FIELD_SENIORENGERECHT = 75;

  /** Förderung, Text 1 */
  protected final static int FIELD_FOERDERUNG = 76;

  /** Anzahl Garage/Stellplatz, Zahl 2 */
  protected final static int FIELD_ANZAHL_GARAGE_STELLPLATZ = 77;
  ...
  protected final static int FIELD_ANZAHL_SCHLAFZIMMER = 81;
  ...
  protected final static int FIELD_AUSSTATTUNG = 98;
  ...
  public static WohnungMiete newRecord( CSVRecord record )
  {
    WohnungMiete is24Record = new WohnungMiete();
