...
-   read XML data according to the specifications of
    ...
    (see [`CasaItReadingExample.java`](https://github.com/OpenEstate/OpenEstate-IO/blob/v1.0-RC1/Examples/src/main/java/org/openestate/io/examples/CasaItReadingExample.java))
-   write XML data according to the specifications of
    [*casa.it*](http://casa.it)
    (see [`CasaItWritingExample.java`](https://github.com/OpenEstate/OpenEstate-IO/blob/v1.0-RC1/Examples/src/main/java/org/openestate/io/examples/CasaItWritingExample.java))
