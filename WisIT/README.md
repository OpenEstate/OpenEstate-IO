...
[DTD specification](specs/wis.dtd) to us. We've converted this spefification
into an [inofficial XSD](specs/inofficial.xsd) file, that is compatible with the
...
-   [Validator for WisIT-XML](http://validator.openestate.org/)
